...
enum Spotify {
    ...
    static let redirectUri              = URL(string:"gymFlo://")!
    static let spotifyClientId          = "089945919f7f4004aff642d4a9fd289d"
    static let spotifyClientSecretKey   = "e01379552f21491b912259465b54b825"
